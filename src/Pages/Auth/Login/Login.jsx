          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full py-3 px-4 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
              >
